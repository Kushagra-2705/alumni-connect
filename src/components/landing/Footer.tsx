...
const Footer = () => {
  ...
  return (
    <footer id="about" className="relative bg-card border-t border-border">
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm">
              Connecting students and alumni for mentorship, career growth, and lifelong professional relationships.
            </p>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Made with ❤️ for students and alumni everywhere
          </p>
        </div>
      </div>
    </footer>
